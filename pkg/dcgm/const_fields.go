...
const (
	...
	// DCGM_FI_DEV_NVLINK_PPRM_OPER_RECOVERY represents NVLINK PPRM operational recovery
	DCGM_FI_DEV_NVLINK_PPRM_OPER_RECOVERY Short = 580
	// DCGM_FI_DEV_NVLINK_PPCNT_RECOVERY_TIME_SINCE_LAST represents NVLINK PPCNT recovery time since last event
	DCGM_FI_DEV_NVLINK_PPCNT_RECOVERY_TIME_SINCE_LAST Short = 581
	// DCGM_FI_DEV_NVLINK_PPCNT_RECOVERY_TIME_BETWEEN_LAST_TWO represents NVLINK PPCNT recovery time between last two events
	DCGM_FI_DEV_NVLINK_PPCNT_RECOVERY_TIME_BETWEEN_LAST_TWO Short = 582
	// DCGM_FI_DEV_NVLINK_PPCNT_RECOVERY_TOTAL_SUCCESSFUL_EVENTS represents NVLINK PPCNT total successful recovery events
	DCGM_FI_DEV_NVLINK_PPCNT_RECOVERY_TOTAL_SUCCESSFUL_EVENTS Short = 583
	// DCGM_FI_DEV_NVLINK_PPCNT_PHYSICAL_SUCCESSFUL_RECOVERY_EVENTS represents NVLINK PPCNT physical successful recovery events
	DCGM_FI_DEV_NVLINK_PPCNT_PHYSICAL_SUCCESSFUL_RECOVERY_EVENTS Short = 584
	// DCGM_FI_DEV_NVLINK_PPCNT_PHYSICAL_LINK_DOWN_COUNTER represents NVLINK PPCNT physical link down counter
	DCGM_FI_DEV_NVLINK_PPCNT_PHYSICAL_LINK_DOWN_COUNTER Short = 585
	// DCGM_FI_DEV_NVLINK_PPCNT_PLR_RCV_CODES represents NVLINK PPCNT PLR receive codes
	DCGM_FI_DEV_NVLINK_PPCNT_PLR_RCV_CODES Short = 586
	// DCGM_FI_DEV_NVLINK_PPCNT_PLR_RCV_CODE_ERR represents NVLINK PPCNT PLR receive code errors
	DCGM_FI_DEV_NVLINK_PPCNT_PLR_RCV_CODE_ERR Short = 587
	// DCGM_FI_DEV_NVLINK_PPCNT_PLR_RCV_UNCORRECTABLE_CODE represents NVLINK PPCNT PLR receive uncorrectable codes
	DCGM_FI_DEV_NVLINK_PPCNT_PLR_RCV_UNCORRECTABLE_CODE Short = 588
	// DCGM_FI_DEV_NVLINK_PPCNT_PLR_XMIT_CODES represents NVLINK PPCNT PLR transmit codes
	DCGM_FI_DEV_NVLINK_PPCNT_PLR_XMIT_CODES Short = 589
	// DCGM_FI_DEV_NVLINK_PPCNT_PLR_XMIT_RETRY_CODES represents NVLINK PPCNT PLR transmit retry codes
	DCGM_FI_DEV_NVLINK_PPCNT_PLR_XMIT_RETRY_CODES Short = 590
	// DCGM_FI_DEV_NVLINK_PPCNT_PLR_XMIT_RETRY_EVENTS represents NVLINK PPCNT PLR transmit retry events
	DCGM_FI_DEV_NVLINK_PPCNT_PLR_XMIT_RETRY_EVENTS Short = 591
	// DCGM_FI_DEV_NVLINK_PPCNT_PLR_SYNC_EVENTS represents NVLINK PPCNT PLR sync events
	...
	// DCGM_FI_DEV_PWR_SMOOTHING_ENABLED represents the enablement of power smoothing (0/DISABLED or 1/ENABLED)
	DCGM_FI_DEV_PWR_SMOOTHING_ENABLED Short = 1425
	// DCGM_FI_DEV_PWR_SMOOTHING_PRIV_LVL represents the current privilege level for power smoothing
	DCGM_FI_DEV_PWR_SMOOTHING_PRIV_LVL Short = 1426
	// DCGM_FI_DEV_PWR_SMOOTHING_IMM_RAMP_DOWN_ENABLED represents the immediate ramp down enablement for power smoothing (0/DISABLED or 1/ENABLED)
	DCGM_FI_DEV_PWR_SMOOTHING_IMM_RAMP_DOWN_ENABLED Short = 1427
	// DCGM_FI_DEV_PWR_SMOOTHING_APPLIED_TMP_CEIL represents the applied TMP ceiling value in Watts
	DCGM_FI_DEV_PWR_SMOOTHING_APPLIED_TMP_CEIL Short = 1428
	// DCGM_FI_DEV_PWR_SMOOTHING_APPLIED_TMP_FLOOR represents the applied TMP floor value in Watts
	DCGM_FI_DEV_PWR_SMOOTHING_APPLIED_TMP_FLOOR Short = 1429
	// DCGM_FI_DEV_PWR_SMOOTHING_MAX_PERCENT_TMP_FLOOR_SETTING represents the maximum percentage TMP Floor value
	DCGM_FI_DEV_PWR_SMOOTHING_MAX_PERCENT_TMP_FLOOR_SETTING Short = 1430
	// DCGM_FI_DEV_PWR_SMOOTHING_MIN_PERCENT_TMP_FLOOR_SETTING represents the minimum percentage TMP Floor value
	DCGM_FI_DEV_PWR_SMOOTHING_MIN_PERCENT_TMP_FLOOR_SETTING Short = 1431
	// DCGM_FI_DEV_PWR_SMOOTHING_HW_CIRCUITRY_PERCENT_LIFETIME_REMAINING represents the HW Circuitry percentage lifetime remaining
	DCGM_FI_DEV_PWR_SMOOTHING_HW_CIRCUITRY_PERCENT_LIFETIME_REMAINING Short = 1432
	// DCGM_FI_DEV_PWR_SMOOTHING_MAX_NUM_PRESET_PROFILES represents the maximum number of preset profiles
	DCGM_FI_DEV_PWR_SMOOTHING_MAX_NUM_PRESET_PROFILES Short = 1433
	// DCGM_FI_DEV_PWR_SMOOTHING_PROFILE_PERCENT_TMP_FLOOR represents the percentage TMP floor for a given profile
	DCGM_FI_DEV_PWR_SMOOTHING_PROFILE_PERCENT_TMP_FLOOR Short = 1434
	// DCGM_FI_DEV_PWR_SMOOTHING_PROFILE_RAMP_UP_RATE represents the ramp up rate in mW/s for a given profile
	DCGM_FI_DEV_PWR_SMOOTHING_PROFILE_RAMP_UP_RATE Short = 1435
	// DCGM_FI_DEV_PWR_SMOOTHING_PROFILE_RAMP_DOWN_RATE represents the ramp down rate in mW/s for a given profile
	DCGM_FI_DEV_PWR_SMOOTHING_PROFILE_RAMP_DOWN_RATE Short = 1436
	// DCGM_FI_DEV_PWR_SMOOTHING_PROFILE_RAMP_DOWN_HYST_VAL represents the ramp down hysteresis value in ms for a given profile
	DCGM_FI_DEV_PWR_SMOOTHING_PROFILE_RAMP_DOWN_HYST_VAL Short = 1437
	// DCGM_FI_DEV_PWR_SMOOTHING_ACTIVE_PRESET_PROFILE represents the active preset profile number
	DCGM_FI_DEV_PWR_SMOOTHING_ACTIVE_PRESET_PROFILE Short = 1438
	// DCGM_FI_DEV_PWR_SMOOTHING_ADMIN_OVERRIDE_PERCENT_TMP_FLOOR represents the percentage TMP floor for admin override
	DCGM_FI_DEV_PWR_SMOOTHING_ADMIN_OVERRIDE_PERCENT_TMP_FLOOR Short = 1439
	// DCGM_FI_DEV_PWR_SMOOTHING_ADMIN_OVERRIDE_RAMP_UP_RATE represents the ramp up rate in mW/s for admin override
	DCGM_FI_DEV_PWR_SMOOTHING_ADMIN_OVERRIDE_RAMP_UP_RATE Short = 1440
	// DCGM_FI_DEV_PWR_SMOOTHING_ADMIN_OVERRIDE_RAMP_DOWN_RATE represents the ramp down rate in mW/s for admin override
	DCGM_FI_DEV_PWR_SMOOTHING_ADMIN_OVERRIDE_RAMP_DOWN_RATE Short = 1441
	// DCGM_FI_DEV_PWR_SMOOTHING_ADMIN_OVERRIDE_RAMP_DOWN_HYST_VAL represents the ramp down hysteresis value in ms for admin override
...
var dcgmFields = map[string]Short{
	...
	// NVLINK PPRM/PPCNT fields
	"DCGM_FI_DEV_NVLINK_PPRM_OPER_RECOVERY":                             DCGM_FI_DEV_NVLINK_PPRM_OPER_RECOVERY,                             // 580
	"DCGM_FI_DEV_NVLINK_PPCNT_RECOVERY_TIME_SINCE_LAST":                 DCGM_FI_DEV_NVLINK_PPCNT_RECOVERY_TIME_SINCE_LAST,                 // 581
	"DCGM_FI_DEV_NVLINK_PPCNT_RECOVERY_TIME_BETWEEN_LAST_TWO":           DCGM_FI_DEV_NVLINK_PPCNT_RECOVERY_TIME_BETWEEN_LAST_TWO,           // 582
	"DCGM_FI_DEV_NVLINK_PPCNT_RECOVERY_TOTAL_SUCCESSFUL_EVENTS":         DCGM_FI_DEV_NVLINK_PPCNT_RECOVERY_TOTAL_SUCCESSFUL_EVENTS,         // 583
	"DCGM_FI_DEV_NVLINK_PPCNT_PHYSICAL_SUCCESSFUL_RECOVERY_EVENTS":      DCGM_FI_DEV_NVLINK_PPCNT_PHYSICAL_SUCCESSFUL_RECOVERY_EVENTS,      // 584
	"DCGM_FI_DEV_NVLINK_PPCNT_PHYSICAL_LINK_DOWN_COUNTER":               DCGM_FI_DEV_NVLINK_PPCNT_PHYSICAL_LINK_DOWN_COUNTER,               // 585
	"DCGM_FI_DEV_NVLINK_PPCNT_PLR_RCV_CODES":                            DCGM_FI_DEV_NVLINK_PPCNT_PLR_RCV_CODES,                            // 586
	"DCGM_FI_DEV_NVLINK_PPCNT_PLR_RCV_CODE_ERR":                         DCGM_FI_DEV_NVLINK_PPCNT_PLR_RCV_CODE_ERR,                         // 587
	"DCGM_FI_DEV_NVLINK_PPCNT_PLR_RCV_UNCORRECTABLE_CODE":               DCGM_FI_DEV_NVLINK_PPCNT_PLR_RCV_UNCORRECTABLE_CODE,               // 588
	"DCGM_FI_DEV_NVLINK_PPCNT_PLR_XMIT_CODES":                           DCGM_FI_DEV_NVLINK_PPCNT_PLR_XMIT_CODES,                           // 589
	"DCGM_FI_DEV_NVLINK_PPCNT_PLR_XMIT_RETRY_CODES":                     DCGM_FI_DEV_NVLINK_PPCNT_PLR_XMIT_RETRY_CODES,                     // 590
	"DCGM_FI_DEV_NVLINK_PPCNT_PLR_XMIT_RETRY_EVENTS":                    DCGM_FI_DEV_NVLINK_PPCNT_PLR_XMIT_RETRY_EVENTS,                    // 591
	"DCGM_FI_DEV_NVLINK_PPCNT_PLR_SYNC_EVENTS":                          DCGM_FI_DEV_NVLINK_PPCNT_PLR_SYNC_EVENTS,                          // 592
	...
	"DCGM_FI_DEV_PWR_SMOOTHING_ENABLED":                                 DCGM_FI_DEV_PWR_SMOOTHING_ENABLED,                                 // 1425
	"DCGM_FI_DEV_PWR_SMOOTHING_PRIV_LVL":                                DCGM_FI_DEV_PWR_SMOOTHING_PRIV_LVL,                                // 1426
	"DCGM_FI_DEV_PWR_SMOOTHING_IMM_RAMP_DOWN_ENABLED":                   DCGM_FI_DEV_PWR_SMOOTHING_IMM_RAMP_DOWN_ENABLED,                   // 1427
	"DCGM_FI_DEV_PWR_SMOOTHING_APPLIED_TMP_CEIL":                        DCGM_FI_DEV_PWR_SMOOTHING_APPLIED_TMP_CEIL,                        // 1428
	"DCGM_FI_DEV_PWR_SMOOTHING_APPLIED_TMP_FLOOR":                       DCGM_FI_DEV_PWR_SMOOTHING_APPLIED_TMP_FLOOR,                       // 1429
	"DCGM_FI_DEV_PWR_SMOOTHING_MAX_PERCENT_TMP_FLOOR_SETTING":           DCGM_FI_DEV_PWR_SMOOTHING_MAX_PERCENT_TMP_FLOOR_SETTING,           // 1430
	"DCGM_FI_DEV_PWR_SMOOTHING_MIN_PERCENT_TMP_FLOOR_SETTING":           DCGM_FI_DEV_PWR_SMOOTHING_MIN_PERCENT_TMP_FLOOR_SETTING,           // 1431
	"DCGM_FI_DEV_PWR_SMOOTHING_HW_CIRCUITRY_PERCENT_LIFETIME_REMAINING": DCGM_FI_DEV_PWR_SMOOTHING_HW_CIRCUITRY_PERCENT_LIFETIME_REMAINING, // 1432
	"DCGM_FI_DEV_PWR_SMOOTHING_MAX_NUM_PRESET_PROFILES":                 DCGM_FI_DEV_PWR_SMOOTHING_MAX_NUM_PRESET_PROFILES,                 // 1433
	"DCGM_FI_DEV_PWR_SMOOTHING_PROFILE_PERCENT_TMP_FLOOR":               DCGM_FI_DEV_PWR_SMOOTHING_PROFILE_PERCENT_TMP_FLOOR,               // 1434
	"DCGM_FI_DEV_PWR_SMOOTHING_PROFILE_RAMP_UP_RATE":                    DCGM_FI_DEV_PWR_SMOOTHING_PROFILE_RAMP_UP_RATE,                    // 1435
	"DCGM_FI_DEV_PWR_SMOOTHING_PROFILE_RAMP_DOWN_RATE":                  DCGM_FI_DEV_PWR_SMOOTHING_PROFILE_RAMP_DOWN_RATE,                  // 1436
	"DCGM_FI_DEV_PWR_SMOOTHING_PROFILE_RAMP_DOWN_HYST_VAL":              DCGM_FI_DEV_PWR_SMOOTHING_PROFILE_RAMP_DOWN_HYST_VAL,              // 1437
	"DCGM_FI_DEV_PWR_SMOOTHING_ACTIVE_PRESET_PROFILE":                   DCGM_FI_DEV_PWR_SMOOTHING_ACTIVE_PRESET_PROFILE,                   // 1438
	"DCGM_FI_DEV_PWR_SMOOTHING_ADMIN_OVERRIDE_PERCENT_TMP_FLOOR":        DCGM_FI_DEV_PWR_SMOOTHING_ADMIN_OVERRIDE_PERCENT_TMP_FLOOR,        // 1439
	"DCGM_FI_DEV_PWR_SMOOTHING_ADMIN_OVERRIDE_RAMP_UP_RATE":             DCGM_FI_DEV_PWR_SMOOTHING_ADMIN_OVERRIDE_RAMP_UP_RATE,             // 1440
	"DCGM_FI_DEV_PWR_SMOOTHING_ADMIN_OVERRIDE_RAMP_DOWN_RATE":           DCGM_FI_DEV_PWR_SMOOTHING_ADMIN_OVERRIDE_RAMP_DOWN_RATE,           // 1441
	"DCGM_FI_DEV_PWR_SMOOTHING_ADMIN_OVERRIDE_RAMP_DOWN_HYST_VAL":       DCGM_FI_DEV_PWR_SMOOTHING_ADMIN_OVERRIDE_RAMP_DOWN_HYST_VAL,       // 1442
	"DCGM_FI_MAX_FIELDS":                                                DCGM_FI_MAX_FIELDS,                                                // 1443
}
