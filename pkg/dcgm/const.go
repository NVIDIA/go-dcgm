...
// HealthCheckError error codes for passive and active health checks.
type HealthCheckError uint

const (
	DCGM_FR_OK                              HealthCheckError = 0   // 0 No error
	DCGM_FR_UNKNOWN                         HealthCheckError = 1   // 1 Unknown error code
	DCGM_FR_UNRECOGNIZED                    HealthCheckError = 2   // 2 Unrecognized error code
	DCGM_FR_PCI_REPLAY_RATE                 HealthCheckError = 3   // 3 Unacceptable rate of PCI errors
	DCGM_FR_VOLATILE_DBE_DETECTED           HealthCheckError = 4   // 4 Uncorrectable volatile double bit error
	DCGM_FR_VOLATILE_SBE_DETECTED           HealthCheckError = 5   // 5 Unacceptable rate of volatile single bit errors
	DCGM_FR_PENDING_PAGE_RETIREMENTS        HealthCheckError = 6   // 6 Pending page retirements detected
	DCGM_FR_RETIRED_PAGES_LIMIT             HealthCheckError = 7   // 7 Unacceptable total page retirements detected
	DCGM_FR_RETIRED_PAGES_DBE_LIMIT         HealthCheckError = 8   // 8 Unacceptable total page retirements due to uncorrectable errors
	DCGM_FR_CORRUPT_INFOROM                 HealthCheckError = 9   // 9 Corrupt inforom found
	DCGM_FR_CLOCK_THROTTLE_THERMAL          HealthCheckError = 10  // 10 Clocks being throttled due to overheating
	DCGM_FR_POWER_UNREADABLE                HealthCheckError = 11  // 11 Cannot get a reading for power from NVML
	DCGM_FR_CLOCK_THROTTLE_POWER            HealthCheckError = 12  // 12 Clock being throttled due to power restrictions
	DCGM_FR_NVLINK_ERROR_THRESHOLD          HealthCheckError = 13  // 13 Unacceptable rate of NVLink errors
	DCGM_FR_NVLINK_DOWN                     HealthCheckError = 14  // 14 NVLink is down
	DCGM_FR_NVSWITCH_FATAL_ERROR            HealthCheckError = 15  // 15 Fatal errors on the NVSwitch
	DCGM_FR_NVSWITCH_NON_FATAL_ERROR        HealthCheckError = 16  // 16 Non-fatal errors on the NVSwitch
	DCGM_FR_NVSWITCH_DOWN                   HealthCheckError = 17  // 17 NVSwitch is down - NOT USED: DEPRECATED
	DCGM_FR_NO_ACCESS_TO_FILE               HealthCheckError = 18  // 18 Cannot access a file
	DCGM_FR_NVML_API                        HealthCheckError = 19  // 19 Error occurred on an NVML API - NOT USED: DEPRECATED
	DCGM_FR_DEVICE_COUNT_MISMATCH           HealthCheckError = 20  // 20 Disagreement in GPU count between /dev and NVML
	DCGM_FR_BAD_PARAMETER                   HealthCheckError = 21  // 21 Bad parameter passed to API
	DCGM_FR_CANNOT_OPEN_LIB                 HealthCheckError = 22  // 22 Cannot open a library that must be accessed
	DCGM_FR_DENYLISTED_DRIVER               HealthCheckError = 23  // 23 A driver on the denylist (nouveau) is active
	DCGM_FR_NVML_LIB_BAD                    HealthCheckError = 24  // 24 NVML library is missing expected functions - NOT USED: DEPRECATED
	DCGM_FR_GRAPHICS_PROCESSES              HealthCheckError = 25  // 25 Graphics processes are active on this GPU
	DCGM_FR_HOSTENGINE_CONN                 HealthCheckError = 26  // 26 Bad connection to nv-hostengine - NOT USED: DEPRECATED
	DCGM_FR_FIELD_QUERY                     HealthCheckError = 27  // 27 Error querying a field from DCGM
	DCGM_FR_BAD_CUDA_ENV                    HealthCheckError = 28  // 28 The environment has variables that hurt CUDA
	DCGM_FR_PERSISTENCE_MODE                HealthCheckError = 29  // 29 Persistence mode is disabled
	DCGM_FR_LOW_BANDWIDTH                   HealthCheckError = 30  // 30 The bandwidth is unacceptably low
	DCGM_FR_HIGH_LATENCY                    HealthCheckError = 31  // 31 Latency is too high
	DCGM_FR_CANNOT_GET_FIELD_TAG            HealthCheckError = 32  // 32 Cannot find a tag for a field
	DCGM_FR_FIELD_VIOLATION                 HealthCheckError = 33  // 33 The value for the specified error field is above 0
	DCGM_FR_FIELD_THRESHOLD                 HealthCheckError = 34  // 34 The value for the specified field is above the threshold
	DCGM_FR_FIELD_VIOLATION_DBL             HealthCheckError = 35  // 35 The value for the specified error field is above 0
	DCGM_FR_FIELD_THRESHOLD_DBL             HealthCheckError = 36  // 36 The value for the specified field is above the threshold
	DCGM_FR_UNSUPPORTED_FIELD_TYPE          HealthCheckError = 37  // 37 Field type cannot be supported
	DCGM_FR_FIELD_THRESHOLD_TS              HealthCheckError = 38  // 38 The value for the specified field is above the threshold
	DCGM_FR_FIELD_THRESHOLD_TS_DBL          HealthCheckError = 39  // 39 The value for the specified field is above the threshold
	DCGM_FR_THERMAL_VIOLATIONS              HealthCheckError = 40  // 40 Thermal violations detected
	DCGM_FR_THERMAL_VIOLATIONS_TS           HealthCheckError = 41  // 41 Thermal violations detected with a timestamp
	DCGM_FR_TEMP_VIOLATION                  HealthCheckError = 42  // 42 Temperature is too high
	DCGM_FR_THROTTLING_VIOLATION            HealthCheckError = 43  // 43 Non-benign clock throttling is occurring
	DCGM_FR_INTERNAL                        HealthCheckError = 44  // 44 An internal error was detected
	DCGM_FR_PCIE_GENERATION                 HealthCheckError = 45  // 45 PCIe generation is too low
	DCGM_FR_PCIE_WIDTH                      HealthCheckError = 46  // 46 PCIe width is too low
	DCGM_FR_ABORTED                         HealthCheckError = 47  // 47 Test was aborted by a user signal
	DCGM_FR_TEST_DISABLED                   HealthCheckError = 48  // 48 This test is disabled for this GPU
	DCGM_FR_CANNOT_GET_STAT                 HealthCheckError = 49  // 49 Cannot get telemetry for a needed value
	DCGM_FR_STRESS_LEVEL                    HealthCheckError = 50  // 50 Stress level is too low (bad performance)
	DCGM_FR_CUDA_API                        HealthCheckError = 51  // 51 Error calling the specified CUDA API
	DCGM_FR_FAULTY_MEMORY                   HealthCheckError = 52  // 52 Faulty memory detected on this GPU
	DCGM_FR_CANNOT_SET_WATCHES              HealthCheckError = 53  // 53 Unable to set field watches in DCGM - NOT USED: DEPRECATED
	DCGM_FR_CUDA_UNBOUND                    HealthCheckError = 54  // 54 CUDA context is no longer bound
	DCGM_FR_ECC_DISABLED                    HealthCheckError = 55  // 55 ECC memory is disabled right now
	DCGM_FR_MEMORY_ALLOC                    HealthCheckError = 56  // 56 Cannot allocate memory on the GPU
	DCGM_FR_CUDA_DBE                        HealthCheckError = 57  // 57 CUDA detected unrecovable double-bit error
	DCGM_FR_MEMORY_MISMATCH                 HealthCheckError = 58  // 58 Memory error detected
	DCGM_FR_CUDA_DEVICE                     HealthCheckError = 59  // 59 No CUDA device discoverable for existing GPU
	DCGM_FR_ECC_UNSUPPORTED                 HealthCheckError = 60  // 60 ECC memory is unsupported by this SKU
	DCGM_FR_ECC_PENDING                     HealthCheckError = 61  // 61 ECC memory is in a pending state - NOT USED: DEPRECATED
	DCGM_FR_MEMORY_BANDWIDTH                HealthCheckError = 62  // 62 Memory bandwidth is too low
	DCGM_FR_TARGET_POWER                    HealthCheckError = 63  // 63 Cannot hit the target power draw
	DCGM_FR_API_FAIL                        HealthCheckError = 64  // 64 The specified API call failed
	DCGM_FR_API_FAIL_GPU                    HealthCheckError = 65  // 65 The specified API call failed for the specified GPU
	DCGM_FR_CUDA_CONTEXT                    HealthCheckError = 66  // 66 Cannot create a CUDA context on this GPU
	DCGM_FR_DCGM_API                        HealthCheckError = 67  // 67 DCGM API failure
	DCGM_FR_CONCURRENT_GPUS                 HealthCheckError = 68  // 68 Need multiple GPUs to run this test
	DCGM_FR_TOO_MANY_ERRORS                 HealthCheckError = 69  // 69 More errors than fit in the return struct - NOT USED: DEPRECATED
	DCGM_FR_NVLINK_CRC_ERROR_THRESHOLD      HealthCheckError = 70  // 70 More than 100 CRC errors are happening per second
	DCGM_FR_NVLINK_ERROR_CRITICAL           HealthCheckError = 71  // 71 NVLink error for a field that should always be 0
	DCGM_FR_ENFORCED_POWER_LIMIT            HealthCheckError = 72  // 72 The enforced power limit is too low to hit the target
	DCGM_FR_MEMORY_ALLOC_HOST               HealthCheckError = 73  // 73 Cannot allocate memory on the host
	DCGM_FR_GPU_OP_MODE                     HealthCheckError = 74  // 74 Bad GPU operating mode for running plugin - NOT USED: DEPRECATED
	DCGM_FR_NO_MEMORY_CLOCKS                HealthCheckError = 75  // 75 No memory clocks with the needed MHz found - NOT USED: DEPRECATED
	DCGM_FR_NO_GRAPHICS_CLOCKS              HealthCheckError = 76  // 76 No graphics clocks with the needed MHz found - NOT USED: DEPRECATED
	DCGM_FR_HAD_TO_RESTORE_STATE            HealthCheckError = 77  // 77 Note that we had to restore a GPU's state
	DCGM_FR_L1TAG_UNSUPPORTED               HealthCheckError = 78  // 78 L1TAG test is unsupported by this SKU
	DCGM_FR_L1TAG_MISCOMPARE                HealthCheckError = 79  // 79 L1TAG test failed on a miscompare
	DCGM_FR_ROW_REMAP_FAILURE               HealthCheckError = 80  // 80 Row remapping failed (Ampere or newer GPUs)
	DCGM_FR_UNCONTAINED_ERROR               HealthCheckError = 81  // 81 Uncontained error - XID 95
	DCGM_FR_EMPTY_GPU_LIST                  HealthCheckError = 82  // 82 No GPU information given to plugin
	DCGM_FR_DBE_PENDING_PAGE_RETIREMENTS    HealthCheckError = 83  // 83 Pending page retirements due to a DBE
	DCGM_FR_UNCORRECTABLE_ROW_REMAP         HealthCheckError = 84  // 84 Uncorrectable row remapping
	DCGM_FR_PENDING_ROW_REMAP               HealthCheckError = 85  // 85 Row remapping is pending
	DCGM_FR_BROKEN_P2P_MEMORY_DEVICE        HealthCheckError = 86  // 86 P2P copy test detected an error writing to this GPU
	DCGM_FR_BROKEN_P2P_WRITER_DEVICE        HealthCheckError = 87  // 87 P2P copy test detected an error writing from this GPU
	DCGM_FR_NVSWITCH_NVLINK_DOWN            HealthCheckError = 88  // 88 An NvLink is down for the specified NVSwitch - NOT USED: DEPRECATED
	DCGM_FR_EUD_BINARY_PERMISSIONS          HealthCheckError = 89  // 89 EUD binary permissions are incorrect
	DCGM_FR_EUD_NON_ROOT_USER               HealthCheckError = 90  // 90 EUD plugin is not running as root
	DCGM_FR_EUD_SPAWN_FAILURE               HealthCheckError = 91  // 91 EUD plugin failed to spawn the EUD binary
	DCGM_FR_EUD_TIMEOUT                     HealthCheckError = 92  // 92 EUD plugin timed out
	DCGM_FR_EUD_ZOMBIE                      HealthCheckError = 93  // 93 EUD process remains running after the plugin considers it finished
	DCGM_FR_EUD_NON_ZERO_EXIT_CODE          HealthCheckError = 94  // 94 EUD process exited with a non-zero exit code
	DCGM_FR_EUD_TEST_FAILED                 HealthCheckError = 95  // 95 EUD test failed
	DCGM_FR_FILE_CREATE_PERMISSIONS         HealthCheckError = 96  // 96 We cannot create a file in this directory.
	DCGM_FR_PAUSE_RESUME_FAILED             HealthCheckError = 97  // 97 Pause/Resume failed
	DCGM_FR_PCIE_H_REPLAY_VIOLATION         HealthCheckError = 98  // 98 PCIe test caught correctable errors
	DCGM_FR_GPU_EXPECTED_NVLINKS_UP         HealthCheckError = 99  // 99 Expected nvlinks up per gpu
	DCGM_FR_NVSWITCH_EXPECTED_NVLINKS_UP    HealthCheckError = 100 // 100 Expected nvlinks up per nvswitch
	DCGM_FR_XID_ERROR                       HealthCheckError = 101 // 101 XID error detected
	DCGM_FR_SBE_VIOLATION                   HealthCheckError = 102 // 102 Single bit error detected
	DCGM_FR_DBE_VIOLATION                   HealthCheckError = 103 // 103 Double bit error detected
	DCGM_FR_PCIE_REPLAY_VIOLATION           HealthCheckError = 104 // 104 PCIe replay errors detected
	DCGM_FR_SBE_THRESHOLD_VIOLATION         HealthCheckError = 105 // 105 SBE threshold violated
	DCGM_FR_DBE_THRESHOLD_VIOLATION         HealthCheckError = 106 // 106 DBE threshold violated
	DCGM_FR_PCIE_REPLAY_THRESHOLD_VIOLATION HealthCheckError = 107 // 107 PCIE replay count violated
	DCGM_FR_CUDA_FM_NOT_INITIALIZED         HealthCheckError = 108 // 108 The fabricmanager is not initialized
	DCGM_FR_SXID_ERROR                      HealthCheckError = 109 // 109 NvSwitch fatal error detected
	DCGM_FR_ERROR_SENTINEL                  HealthCheckError = 110 // 110 MUST BE THE LAST ERROR CODE
)
